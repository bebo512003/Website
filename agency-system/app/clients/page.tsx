...
export default function ClientsPage() {
  ...
  return (
    <Page>
      <PageHeader eyebrow="CLIENTS / DIRECTORY" title="Clients" description="Client records are secured by the same project access rules as the rest of the workspace." action={canCreate ? <button onClick={openCreate} className={primaryButtonClassName}><Plus className="h-4 w-4" /> New client</button> : undefined} />
