      ...
      <div className="mx-auto max-w-7xl px-5 pb-20 pt-8 sm:px-8 lg:px-10 lg:pt-12">
        ...
        <section className="mt-20 border-t border-white/10 pt-10">
          <div className="flex flex-col justify-between gap-6 sm:flex-row sm:items-center">
            ...
            <Link href="/forms" className="inline-flex items-center justify-center gap-2 border border-accent bg-accent px-5 py-3 text-sm font-semibold text-accent-foreground transition hover:brightness-110">Request a New Project <ArrowUpRight className="h-4 w-4" /></Link>
          </div>
        </section>
      </div>
    </div>
